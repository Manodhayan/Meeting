...
function changePerson() {
  ...
  var PersonName_FirstPage = document.getElementById("PersonName");
  ...
  for (var iter = 0; iter < NumberofPages; iter++) {
    card_image[iter].attributes[1].value = "../images/lary.jpg";
  }
  PersonName_FirstPage.innerHTML = PersonName_SecondPage.innerHTML = PersonName_ThirdPage.innerHTML = PersonName;
